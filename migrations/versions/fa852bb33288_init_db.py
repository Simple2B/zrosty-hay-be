...
Revision ID: fa852bb33288
Revises:
Create Date: 2024-01-15 10:59:54.443706
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["illness_id"],
            ["illnesses.id"],
            name=op.f("fk_illness_photos_illness_id_illnesses"),
        ),
        sa.ForeignKeyConstraint(
            ["photo_id"], ["photos.id"], name=op.f("fk_illness_photos_photo_id_photos")
        ),
        sa.PrimaryKeyConstraint(
            "illness_id", "photo_id", name=op.f("pk_illness_photos")
        ),
    )
    op.create_table(
        "pest_photos",
        ...
        sa.Column("photo_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["pest_id"], ["pests.id"], name=op.f("fk_pest_photos_pest_id_pests")
        ),
        sa.ForeignKeyConstraint(
            ["photo_id"], ["photos.id"], name=op.f("fk_pest_photos_photo_id_photos")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["illness_id"],
            ["illnesses.id"],
            name=op.f("fk_plant_family_illnesses_illness_id_illnesses"),
        ),
        sa.ForeignKeyConstraint(
            ["plant_family_id"],
            ["plant_families.id"],
            name=op.f("fk_plant_family_illnesses_plant_family_id_plant_families"),
        ),
        sa.PrimaryKeyConstraint(
            "plant_family_id", "illness_id", name=op.f("pk_plant_family_illnesses")
        ),
    )
    op.create_table(
        "plant_family_pests",
        ...
        sa.Column("pest_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["pest_id"], ["pests.id"], name=op.f("fk_plant_family_pests_pest_id_pests")
        ),
        sa.ForeignKeyConstraint(
            ["plant_family_id"],
            ["plant_families.id"],
            name=op.f("fk_plant_family_pests_plant_family_id_plant_families"),
        ),
        sa.PrimaryKeyConstraint(
            "plant_family_id", "pest_id", name=op.f("pk_plant_family_pests")
        ),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["plant_family_id"],
            ["plant_families.id"],
            name=op.f("fk_plant_family_recipes_plant_family_id_plant_families"),
        ),
        sa.ForeignKeyConstraint(
            ["recipe_id"],
            ["recipes.id"],
            name=op.f("fk_plant_family_recipes_recipe_id_recipes"),
        ),
        sa.PrimaryKeyConstraint(
            "recipe_id", "plant_family_id", name=op.f("pk_plant_family_recipes")
        ),
    )
    op.create_table(
        "plant_varieties",
        ...
        sa.ForeignKeyConstraint(
            ["plant_family_id"],
            ["plant_families.id"],
            name=op.f("fk_plant_varieties_plant_family_id_plant_families"),
        ),
    ...
    op.create_table(
        ...
        sa.Column("photo_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["photo_id"], ["photos.id"], name=op.f("fk_recipe_photos_photo_id_photos")
        ),
        sa.ForeignKeyConstraint(
            ["recipe_id"],
            ["recipes.id"],
            name=op.f("fk_recipe_photos_recipe_id_recipes"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["plant_variety_id"],
            ["plant_varieties.id"],
            name=op.f("fk_conditions_plant_variety_id_plant_varieties"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["plant_variety_id"],
            ["plant_varieties.id"],
            name=op.f("fk_feedbacks_plant_variety_id_plant_varieties"),
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["illness_id"],
            ["illnesses.id"],
            name=op.f("fk_plant_variety_illnesses_illness_id_illnesses"),
        ),
        sa.ForeignKeyConstraint(
            ["plant_variety_id"],
            ["plant_varieties.id"],
            name=op.f("fk_plant_variety_illnesses_plant_variety_id_plant_varieties"),
        ),
        sa.PrimaryKeyConstraint(
            "plant_variety_id", "illness_id", name=op.f("pk_plant_variety_illnesses")
        ),
    )
    op.create_table(
        "plant_variety_pests",
        ...
        sa.Column("pest_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["pest_id"], ["pests.id"], name=op.f("fk_plant_variety_pests_pest_id_pests")
        ),
        sa.ForeignKeyConstraint(
            ["plant_variety_id"],
            ["plant_varieties.id"],
            name=op.f("fk_plant_variety_pests_plant_variety_id_plant_varieties"),
        ),
        sa.PrimaryKeyConstraint(
            "plant_variety_id", "pest_id", name=op.f("pk_plant_variety_pests")
        ),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["photo_id"],
            ["photos.id"],
            name=op.f("fk_plant_variety_photos_photo_id_photos"),
        ),
        sa.ForeignKeyConstraint(
            ["plant_variety_photo_id"],
            ["plant_varieties.id"],
            name=op.f("fk_plant_variety_photos_plant_variety_photo_id_plant_varieties"),
        ),
        sa.PrimaryKeyConstraint(
            "plant_variety_photo_id", "photo_id", name=op.f("pk_plant_variety_photos")
        ),
    )
    op.create_table(
        "planting_programs",
        ...
        sa.ForeignKeyConstraint(
            ["plant_variety_id"],
            ["plant_varieties.id"],
            name=op.f("fk_planting_programs_plant_variety_id_plant_varieties"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["planting_program_id"],
            ["planting_programs.id"],
            name=op.f("fk_planting_steps_planting_program_id_planting_programs"),
        ),
