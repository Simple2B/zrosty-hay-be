...
class RecipeIngredient(db.Model, ModelMixin):
    ...
    plant_family_id: orm.Mapped[int | None] = orm.mapped_column(sa.ForeignKey("plant_families.id"))
    ...
    plant_family: orm.Mapped[Union["PlantVariety", None]] = orm.relationship()
    plant_variety: orm.Mapped[Union["PlantFamily", None]] = orm.relationship()
