...
var $modalElement = document.querySelector('#editPestModal');
var $addpestModalElement = document.querySelector('#add-pest-modal');
var modalOptions = {
...
var addModal = new flowbite_1.Modal($addpestModalElement, modalOptions);
var $buttonElements = document.querySelectorAll('.pest-edit-button');
...
// search flow
var searchInput = document.querySelector('#table-search-pests');
var searchInputButton = document.querySelector('#table-search-pest-button');
...
var deleteButtons = document.querySelectorAll('.delete-pest-btn');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    id = e.getAttribute('data-pest-id');
                    return [4 /*yield*/, fetch("/pest/delete/".concat(id), {
                            method: 'DELETE',
                        })];
                case 1:
                    response = _a.sent();
...
function editPest(pest) {
    var input = document.querySelector('#pest-edit-name');
